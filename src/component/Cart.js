    ...
    <div className="col-lg-4"> 
        <div className="card mb-5 mb-lg-0">
            ...
            <ul className="fa-ul">
                ...
                <li className={props.data.storageEnabler ? "":"text-muted"}><span className="fa-li"><i className={props.data.userEnabler ? "fas fa-check" : "fas fa-times"}></i></span>{props.data.storage}</li>
                ...
                <li className={props.data.subDomainEnabler ? "":"text-muted"}><span className="fa-li"><i className={props.data.subDomainEnabler ? "fas fa-check" : "fas fa-times"}></i></span>{props.data.plan ==='PRO'?<b>Unlimited </b>:<></>}{props.data.subDomain}
                </li>
